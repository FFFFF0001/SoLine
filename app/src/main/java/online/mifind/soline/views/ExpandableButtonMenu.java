package online.mifind.soline.views;
...
public class ExpandableButtonMenu extends RelativeLayout implements View.OnClickListener {
    ...
    ExpandableButtonMenu menu = this;
    /**
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.ebm__menu_overlay) {
            ...
            if (mListener != null){
                mListener.onClick(menu, MenuButton.LEFT);
                toggle();
            }
        } else if (id == R.id.ebm__menu_middle_image) {
            if (mListener != null) {
                mListener.onClick(menu, MenuButton.MID);
                toggle();
            }
        } else if (id == R.id.ebm__menu_right_image) {
            if (mListener != null) {
                mListener.onClick(menu, MenuButton.RIGHT);
                toggle();
            }
    ...
    public interface OnMenuButtonClick {
        public void onClick(ExpandableButtonMenu menu, MenuButton action);
    }
